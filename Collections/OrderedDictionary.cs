...
namespace Paulus.Collections
{
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
    {
        ...
        //added by Paulus to allow operators
        public static implicit operator Dictionary<TKey, TValue>(OrderedDictionary<TKey, TValue> d)
        {
            return d._dictionary;
        }
        ...
        public static implicit operator List<KeyValuePair<TKey, TValue>>(OrderedDictionary<TKey, TValue> d)
        {
            return d._list;
        }
        ...
        public void Insert(int index, TKey key, TValue value)
        {
            ...
            if (!IgnoreEventHandlers) OnItemAdded(newEntry);
        }
        ...
        //------------events by paulus!
        public event EventHandler<EventArgs<KeyValuePair<TKey, TValue>>> ItemAdded;
        protected void OnItemAdded(KeyValuePair<TKey, TValue> entry)
        {
            var handler = ItemAdded;
            if (handler != null) handler(this, new EventArgs<KeyValuePair<TKey, TValue>>(entry));
        }

        public event EventHandler<EventArgs<KeyValuePair<TKey, TValue>>> ItemRemoved;
        protected void OnItemRemoved(KeyValuePair<TKey, TValue> entry, int position)
        {
        ...
        public int Add(TKey key, TValue value)
        {
            ...
            List.Add(entry);
            if (!IgnoreEventHandlers) OnItemAdded(entry); //by paulus
            return Count - 1;
        }
        ...
        object ICollection.SyncRoot
        {
            get
            {
                ...
                {
                    global::System.Threading.Interlocked.CompareExchange(ref this._syncRoot, new object(), null);
                }
