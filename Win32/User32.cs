...
namespace Paulus.Win32
{
    public static class User32
    {
        ...
        #region Legacy mouse events
        [DllImport("user32.dll")]
        public static extern void mouse_event(MouseEventFlags flags, int dX, int dY, int buttons, int extraInfo);

        //Used in legacy mouse_event function
        [Flags]
        ...
        public struct MOUSEINPUT
        {
            ...
            /// A positive value indicates that the wheel was rotated to the right; a negative value indicates that the wheel was rotated to the left. One wheel click is defined as WHEEL_DELTA, which is 120.
        ...
        public static extern IntPtr FindWindowEx(IntPtr hwndParent, IntPtr hwndChildAfter, string lpszClass, IntPtr missing);
        [DllImport("user32.dll", SetLastError = true, EntryPoint = "FindWindowEx")]
        public static extern IntPtr FindWindowEx(IntPtr hwndParent, IntPtr hwndChildAfter, IntPtr missing, string lpszWindow);
        ...
        public delegate IntPtr HookProc(int code, User32.WM wParam, ref MSLLHOOKSTRUCT hook);

        // overload for use with LowLevelMouseProc
        [DllImport("user32.dll")]
        public static extern IntPtr CallNextHookEx(IntPtr hhk, int nCode, WM wParam, ref MSLLHOOKSTRUCT lParam);
    ...
    public struct POINT
    {
        ...
        public static implicit operator global::System.Drawing.Point(POINT p)
        {
            return new global::System.Drawing.Point(p.X, p.Y);
        }

        public static implicit operator POINT(global::System.Drawing.Point p)
        {
