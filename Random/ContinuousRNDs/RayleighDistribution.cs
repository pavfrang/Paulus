...
namespace Paulus.Random
{
	...
	public class RayleighDistribution : Distribution
	{
        ...
        public override double Mean
		{
			get
			{
                return this.sigma * System.Math.Sqrt(Math.PI / 2.0);
			}
		}
        ...
        public override double Median
		{
			get
			{
				return this.sigma * System.Math.Sqrt(Math.Log(4));
			}
		}
        ...
        {
            return System.Math.Sqrt(Math.Pow(this.normalDistribution1.NextDouble(), 2) + Math.Pow(this.normalDistribution2.NextDouble(), 2));
        }
		#endregion
	}
}