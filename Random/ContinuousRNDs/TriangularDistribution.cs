...
namespace Paulus.Random
{
	...
	public class TriangularDistribution : Distribution
	{
        ...
        private void UpdateHelpers()
        {
            ...
            this.helper3 = System.Math.Sqrt(this.helper1 * this.helper2);
            this.helper4 = System.Math.Sqrt(this.beta - this.gamma);
        }
        #endregion
        ...
        public override double Median
		{
			get
			{
                ...
                {
                    return this.alpha +
                        (System.Math.Sqrt((this.beta - this.alpha) * (this.gamma - this.alpha)) / System.Math.Sqrt(2.0));
                }
                else
                {
                    return this.beta -
                        (System.Math.Sqrt((this.beta - this.alpha) * (this.beta - this.gamma)) / System.Math.Sqrt(2.0));
                }
			}
		}
        ...
        public override double NextDouble()
        {
            ...
            {
                return this.alpha + System.Math.Sqrt(genNum) * this.helper3;
            }
            else
            {
                return this.beta - System.Math.Sqrt(genNum * this.helper2 - this.helper1) * this.helper4;
            }
        }
        #endregion
	}
