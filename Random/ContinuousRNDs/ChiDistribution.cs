/*
 * 
 * ChiDistribution.cs, 27.03.2007
 * 
 * 17.08.2006: Initial version
 * 27.03.2007: Overridden the now virtual base class method Reset, so the ChiDistribution is properly reset
...
namespace Paulus.Random
{
	...
	public class ChiDistribution : Distribution
    {
        ...
        private double Gamma(double x)
        {
            ...
            return System.Math.Sqrt(2.0 * Math.PI) / x * Math.Pow(x + 5.5, x + 0.5) / Math.Exp(x + 5.5) * sum;
        }
        #endregion
        ...
        public override double Mean
		{
			get
			{
                return System.Math.Sqrt(2.0) * this.Gamma((this.alpha + 1.0) / 2.0) / this.Gamma(this.alpha / 2.0);
			}
		}
        ...
        public override double[] Mode
		{
            get
            {
                if (this.alpha >= 1)
                {
                    return new double[] { System.Math.Sqrt(this.alpha - 1.0) };
                }
                else
                {
                    return new double[] { };
